...
export const PROVIDER_METAS = [
  { id: "gemini", name: "Google Gemini", badge: "Cloud", description: "Fast multimodal reasoning through Google AI.", defaultModel: "gemini-3.8-flash", defaultBaseUrl: "https://generativelanguage.googleapis.com" },
  { id: "openai", name: "OpenAI", badge: "Cloud", description: "General-purpose models for analysis and writing.", defaultModel: "gpt-4o-mini", defaultBaseUrl: "https://api.openai.com/v1" },
  { id: "anthropic", name: "Anthropic", badge: "Cloud", description: "High-quality reasoning and long-form synthesis.", defaultModel: "claude-3-5-sonnet-latest", defaultBaseUrl: "https://api.anthropic.com" },
  { id: "groq", name: "Groq", badge: "Fast", description: "Low-latency hosted inference.", defaultModel: "llama-3.1-8b-instant", defaultBaseUrl: "https://api.groq.com/openai/v1" },
  { id: "openrouter", name: "OpenRouter", badge: "Multi", description: "Access multiple hosted model families.", defaultModel: "openai/gpt-4o-mini", defaultBaseUrl: "https://openrouter.ai/api/v1" },
  { id: "deepseek", name: "DeepSeek", badge: "Cloud", description: "Efficient reasoning and coding models.", defaultModel: "deepseek-chat", defaultBaseUrl: "https://api.deepseek.com" },
  { id: "mistral", name: "Mistral", badge: "Cloud", description: "Open and efficient European models.", defaultModel: "mistral-small-latest", defaultBaseUrl: "https://api.mistral.ai/v1" },
  { id: "together", name: "Together AI", badge: "Cloud", description: "Hosted open-source model inference.", defaultModel: "meta-llama/Llama-3.3-70B-Instruct-Turbo", defaultBaseUrl: "https://api.together.xyz/v1" },
  { id: "perplexity", name: "Perplexity", badge: "Search", description: "Web-grounded model responses.", defaultModel: "sonar", defaultBaseUrl: "https://api.perplexity.ai" },
  { id: "xai", name: "xAI", badge: "Cloud", description: "Grok models for broad reasoning.", defaultModel: "grok-2-latest", defaultBaseUrl: "https://api.x.ai/v1" },
  { id: "cohere", name: "Cohere", badge: "Cloud", description: "Language models and retrieval workflows.", defaultModel: "command-r-plus", defaultBaseUrl: "https://api.cohere.com/compatibility/v1" },
  { id: "nvidia", name: "NVIDIA", badge: "Cloud", description: "Hosted NVIDIA inference endpoints.", defaultModel: "meta/llama-3.1-8b-instruct", defaultBaseUrl: "https://integrate.api.nvidia.com/v1" },
  { id: "local", name: "Local Ollama", badge: "Local", description: "Private local inference through Ollama.", defaultModel: "llama3.1:8b-instruct-q4_K_M", defaultBaseUrl: "http://localhost:11434" },
  { id: "custom", name: "Custom Gateway", badge: "Custom", description: "Connect any OpenAI-compatible endpoint.", defaultModel: "custom-model" },
] as const;
